        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#projects"
                className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 font-medium"
              >
                View My Work
              </a>
              <a
          ...
          <div className="relative">
            <div className="w-[32rem] h-[32rem] mx-auto bg-gradient-to-br from-blue-600 to-purple-600 rounded-full p-2">
              <div className="w-full h-full bg-white rounded-full flex items-center justify-center overflow-hidden">
                <div className="w-[30rem] h-[30rem] bg-gray-200 rounded-full overflow-hidden">
                  <img
                    src={headshot}
                    alt="Your Photo"
